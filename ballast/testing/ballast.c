...
#define NUMARGS 20
    ...
    if(argc !=5){
        printf("Il manque des arguments : \n->-p fichier.blastp -o fichier de sortie\n-> -n fichier t ");
    }
    ...
    conserved = (char *)malloc(length + 1); //on n'oublie pas le +1 car '\0'
    maxprofile = (double *)malloc(sizeof(double) * length +1); //bon on laisse comme ca, jsais plus pourquoi la mémoire est allouée à 4 fois la longueur
    ...
    ptrstr = (char *)(conserved + length); //conserved correspond à la séquence de la query
    *ptrstr = '\0';

   fprintf(stdout, "Initialisation : ok\n");

     /********************************************************************************************************************************/
    /**************************************************CONSTRUCTION DU PROFIL BLAST**************************************************/
   /********************************************************************************************************************************/
    if(length!=0){
        i=1; 
