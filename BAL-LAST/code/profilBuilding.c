   ...
   fixeValue(p, maxp);
    ...
    while (endofdbseq == 0)
    {
       ...
       /*Identities*/
        ...
        {
            /*Recherche du numéro du début et fin de la query*/
            ...
            *ptrstr = '\0';
            ...
            /*Condition permettant de vérifier si nous sommes à la première partie de la séquence de la midline ou non*/
            line[strlen(line)] = '\0';
